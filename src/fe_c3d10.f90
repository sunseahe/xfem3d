...
!  real(rk), parameter :: w(ngp) = [ c, c, c, c ]
  real(rk), parameter :: xa(ngp) =[0.2500000000000000, 0.0000000000000000, 0.3333333333333333, 0.3333333333333333, 0.3333333333333333, &
   ...
   real(rk), parameter :: ya(ngp) =  [0.2500000000000000, 0.3333333333333333, 0.3333333333333333, 0.3333333333333333, 0.0000000000000000, &
   ...
   real(rk), parameter :: za(ngp) =[0.2500000000000000, 0.3333333333333333, 0.3333333333333333, 0.0000000000000000, 0.3333333333333333, &
   ...
   real(rk), parameter :: gp(ngp,dom) = reshape([xa,ya,za], order=[2,1], shape=[ngp,dom])
   real(rk), parameter :: w(ngp)  =[0.1817020685825351, 0.0361607142857143, 0.0361607142857143, 0.0361607142857143, 0.0361607142857143, &
   &  0.0698714945161738, 0.0698714945161738, 0.0698714945161738, 0.0698714945161738, 0.0656948493683187, &
   &  0.0656948493683187, 0.0656948493683187, 0.0656948493683187, 0.0656948493683187, 0.0656948493683187]/6.0_rk
